                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                    ...
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">You can reach us via phone.</p>
                        ...
                        <div>
                            ...
                            <h2 className="mt-4 text-base font-medium text-gray-800 dark:text-white">Office Address</h2>
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Visit us at our office location.</p>
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Ujjain Madhya Pradesh ,India</p>
                        </div>
                    </div>

                    {/* Google Form section */}
                    <div ref={formContainerRef} className="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
                        <iframe 
                            ref={iframeRef}
